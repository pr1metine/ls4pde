...
/**
 * An exception with a line number attached that occurs during either
 * pre-processing, compile, or run time.
 */
public class SketchException extends Exception {
     ...
     * msg.substring("java.lang.".length()); } return msg; //return (dot == -1) ?

...
public class PreprocessorResult {
    ...
    /**
     * Create a new PreprocessorResult indicating that there were issues in
     * preprocessing.
     *
     ...
     * @param newHeaderOffset     The offset (in number of chars) from the start of
     *                            the program at which the header finishes.
     * @param newClassName        The name of the class containing the sketch.
     * @param newImportStatements The imports required for the sketch including
     *                            defaults and core imports.
     * @param newEdits            The edits made during preprocessing.
     * @param newSketchWidth      The width of the sketch in pixels or special value
     *                            like displayWidth;
     * @param newSketchHeight     The height of the sketch in pixels or special
     *                            value like displayWidth;
     */
    public PreprocessorResult(PdePreprocessor.Mode newProgramType, int newHeaderOffset, String newClassName,
            List<ImportStatement> newImportStatements, List<TextTransform.Edit> newEdits, String newSketchWidth,
            String newSketchHeight) {
     ...
     *
     * @return The offset (in number of lines) from the start of the program at
     *         which the header finishes.
     */
     ...
     *
     * @return The width of the sketch in pixels or special value like displayWidth
     ...
     *
     * @return The height of the sketch in pixels or special value like
     *         displayHeight or null if none given.
     */

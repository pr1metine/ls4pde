...
public class TextTransform {
    ...
    private static final Comparator<Edit> INPUT_OFFSET_COMP = (o1, o2) -> Integer.compare(o1.fromOffset, o2.fromOffset);

    private static final Comparator<Edit> OUTPUT_OFFSET_COMP = (o1, o2) -> Integer.compare(o1.toOffset, o2.toOffset);
    ...
    public String apply() {
        ...
        outMap.stream()
                ...
                .filter(outEdit -> outEdit.toLength > 0).forEach(outEdit -> {
    ...
    private void buildIfNeeded(int inLength) {
        if (built && inLength == builtForLength)
            return;
    ...
    public String toString() {
        return "SourceMapping{" + "edits=" + edits + '}';
    }
    ...
    public static class Edit {
        ...
        @Override
        public String toString() {
            return "Edit{" + "from=" + fromOffset + ":" + fromLength + ", to=" + toOffset + ":" + toLength
    ...
    private static class SimpleOffsetMapper implements OffsetMapper {
        ...
        public int getInputOffset(int outputOffset) {
            if (outputOffset < outputOffsetOfInputStart)
                return -1;
            ...
            i = Constrain.constrain(i, 0, outMap.size() - 1);
        ...
        public int getOutputOffset(int inputOffset) {
            if (inputOffset < inputOffsetOfOutputStart)
                return -1;
            ...
            i = Constrain.constrain(i, 0, inMap.size() - 1);
